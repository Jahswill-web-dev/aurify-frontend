...
export function PracticeQuestion({
  ...
  if (!question) {
    return (
      <div className="rounded-md border border-error/30 bg-error-light p-4 dark:bg-error/15">
  ...
  return (
    <div className="rounded-md border border-grey-25 bg-off-white-100 p-4 dark:border-dark-border dark:bg-dark-surface-soft sm:p-5">
            ...
            <button
              ...
              className={[
                ...
                isWrongSelection
                  ...
                  : "",
                hasFeedback && !isCorrectOption && !isWrongSelection
      ...
      {feedback ? (
        <div className={[
          ...
          <div className="mt-3 grid gap-2 text-h5 leading-6 inter-font">
            <p><span className="font-semibold">Selected answer:</span> {feedback.selected_answer || selectedAnswer}</p>
            <p><span className="font-semibold">Correct answer:</span> {feedback.correct_answer}</p>
            {feedback.explanation ? <p><span className="font-semibold">Explanation:</span> {feedback.explanation}</p> : null}
            {feedback.weak_area ? <p><span className="font-semibold">Weak area:</span> {feedback.weak_area}</p> : null}
          </div>
        </div>
      ) : (
