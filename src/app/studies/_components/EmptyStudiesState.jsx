...
function EmptyStudiesState() {
  return (
    <div className="rounded-md border border-dashed border-grey-25 bg-white px-6 py-12 text-center shadow-card dark:border-dark-border dark:bg-dark-surface dark:shadow-none">
      ...
      <Link
        href="/studies/new"
        className="mt-6 inline-flex items-center justify-center gap-2 rounded-sm bg-primary px-4 py-2 text-h5 font-medium text-white shadow-btn-primary transition-all duration-175 hover:bg-primary-200 dark:bg-dark-accent dark:text-[#16110a] dark:shadow-none dark:hover:bg-primary-25"
      >
