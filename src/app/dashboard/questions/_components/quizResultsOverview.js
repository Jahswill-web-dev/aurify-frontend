...
export const QuizResultsOverview = ({
  ...
  useEffect(() => {
    console.log("overview has loaded");
  }, []);
  ...
  const correctAnswers = Object.entries(answers).filter(
    ([questionIndex, answer]) =>
      questions &&
      questions[parseInt(questionIndex)]?.answer ===
        questions[parseInt(questionIndex)]?.options[answer]
  ).length;
  ...
  const correctQuestionsList = Object.entries(answers)
    .filter(
      ([questionIndex, answer]) =>
        ...
        questions[parseInt(questionIndex)]?.answer ===
          questions[parseInt(questionIndex)]?.options[answer]
      // questions[parseInt(questionIndex)]?.answer === questions[parseInt(questionIndex)]?.options[answer]
    )
    .map(([questionIndex, userAnswer]) => ({
      index: parseInt(questionIndex),
      question: questions && questions[parseInt(questionIndex)],
      userAnswer,
  ...
  React.useEffect(() => {
    ...
    correctQuestionsList.length,
    incorrectQuestionsList.length,
    skippedQuestionsList.length,
  ]);
        ...
        {didNotPass && (
          ...
          >
            ...
            <p className="text-red-700 mb-4">
              You did not answer any questions. Please retake the test to
              receive a score.
            </p>
            <motion.button
              whileHover={{ scale: 1.02 }}
          ...
          (correctQuestionsList.length > 0 ||
            ...
            >
                ...
                <div className="flex flex-wrap gap-1 bg-gray-100 rounded-lg p-1">
                  {correctQuestionsList.length > 0 && (
                    ...
                    >
                      ...
                      <span className="hidden sm:inline">
                        Correct ({correctQuestionsList.length})
                      </span>
                  ...
                  {incorrectQuestionsList.length > 0 && (
                    ...
                    >
                      ...
                      <span className="hidden sm:inline">
                        Incorrect ({incorrectQuestionsList.length})
                      </span>
                      <span className="sm:hidden">
                        ✗ {incorrectQuestionsList.length}
                      </span>
                  ...
                  {skippedQuestionsList.length > 0 && (
                    ...
                    >
                      ...
                      <span className="hidden sm:inline">
                        Skipped ({skippedQuestionsList.length})
                      </span>
                      <span className="sm:hidden">
                        - {skippedQuestionsList.length}
                      </span>
              ...
              <div className="divide-y divide-gray-200">
                ...
                {activeTab === "correct" &&
                  correctQuestionsList.map((item, index) => (
                    <motion.div
                    ...
                    >
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.99 }}
                        onClick={() =>
                          toggleQuestionExpansion(`correct-${item.index}`)
                        }
                ...
                {activeTab === "incorrect" &&
                  incorrectQuestionsList.map((item, index) => (
                    <motion.div
                    ...
                    >
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.99 }}
                        onClick={() =>
                          toggleQuestionExpansion(`incorrect-${item.index}`)
                        }
                        className="w-full flex items-start space-x-4 text-left group"
                      >
                ...
                {activeTab === "skipped" &&
                  skippedQuestionsList.map((item, index) => (
                    <motion.div
                    ...
                    >
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.99 }}
                        onClick={() =>
                          toggleQuestionExpansion(`skipped-${item.index}`)
                        }
                        className="w-full flex items-start space-x-4 text-left group"
                      >
