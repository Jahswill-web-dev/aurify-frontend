  ...
  return (
    <div className="dashboard-main">
      ...
      <div className="flex flex-col gap-4 mt-10 px-2">
        <h2 className="text-2xl font-semibold text-p-text-darker">First Heading</h2>
        <p className="text-p-text text-lg">
          ...
          neque gravida in fermentum et sollicitudin ac. Lorem ipsum dolor sit
          ...
          nullam eget felis eget nunc lobortis mattis aliquam. Id donec ultrices
          tincidunt arcu non sodales neque sodales ut. Habitant morbi tristique
          senectus et netus et malesuada. Egestas purus viverra accumsan in nisl
          nisi. Augue neque gravida in fermentum et sollicitudin ac. neque
          gravida in fermentum et sollicitudin ac. Lorem ipsum dolor sit amet,
          ...
          tincidunt arcu non sodales neque sodales ut. Habitant morbi tristique
          senectus et netus et malesuada. Egestas purus viverra accumsan in nisl
          nisi. Augue neque gravida in fermentum et sollicitudin ac.
        </p>
      </div>
    </div>
  );
